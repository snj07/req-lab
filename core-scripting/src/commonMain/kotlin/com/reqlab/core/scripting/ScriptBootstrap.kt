...
var request={get url(){return __r.mutations.url||__ru;},get method(){return __r.mutations.method||__rm;},get body(){return __r.mutations.body!==null?__r.mutations.body:(__rqb||'');},headers:__rqhO,query:__rqpO,params:__rqpO,setHeader:function(n,v){__r.mutations.headers[n]=String(v);},setQueryParam:function(n,v){__r.mutations.queryParams[n]=String(v);},setMethod:function(m){__r.mutations.method=m.toUpperCase();},setUrl:function(u){__r.mutations.url=u;__r.mutations.queryParams={};},setBody:function(b){__r.mutations.body=b;}};
